...
from app.api.routes import admins, departments, jobs, users, tasks, statistics, reviewers, auth
...
router.include_router(reviewers.router, prefix="/reviewers", tags=["reviewers"], include_in_schema=True)
