...
| --- | --- |
| Анна Соколова | штатный график пн–пт, заполнено без пропусков |
| Дмитрий Орлов | пропущенные дни, отгул, сегодняшняя запись в черновике |
| Мария Ильина | сменный график пн/ср/пт |
| Павел Гущин | `schedule_type = none`, регулярность не считается |
| Ольга Титова | статус `invited`, логин отдаёт 403 |
